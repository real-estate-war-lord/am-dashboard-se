...
/* src/listings/parse.js was a twin of src/testprop.js and is gone; both pages
   now parse a pasted link with the same code. The alias keeps the bound checks
   below reading the way they were written. */
const { parseLocation, TP_BOUNDS: LP_BOUNDS } = require("../src/testprop.js");
