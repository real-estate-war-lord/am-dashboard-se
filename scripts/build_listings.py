...
def main() -> None:
    ...
    parts = {
        ...
        # src/listings/parse.js is gone: it was a twin of src/testprop.js and
        # existed only because testprop.js was not on the listings branch. Both
        # pages now parse a pasted Google Maps link with the same code, so the
        # bounds, the patterns and the error messages cannot drift apart.
        "PARSE_JS": read(SRC / "testprop.js"),
